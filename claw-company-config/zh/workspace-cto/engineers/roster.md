...
|------|------|------|------|------|-----------|---------|-------------|
| 產品經理 PM | pm.md | Reed | 📋 | 需求分析、PRD、用戶故事、優先級排序、競品對比 | 3 | ✅ | 產品構想、功能規劃 |
| 架構師 Architect | architect.md | Mason | 🏗️ | 系統設計、技術選型、可擴展模式、技術風險評估 | 2 | ✅ | 技術決策、基礎設施 |
...
| 分析師 Analyst | analyst.md | Hazel | 📊 | 市場研究、需求分析、數據分析、可行性評估 | 1 | ❌ | 商業分析、競爭研究 |
