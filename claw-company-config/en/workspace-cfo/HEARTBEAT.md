...
- If cumulative spending exceeds 80% of budget → exec dispatch to notify CEO "monthly budget nearly exhausted"
...
- If any Agent's daily consumption exceeds 3x daily average → exec dispatch to notify CEO to investigate
...
- **Every Sunday** → produce "API Salary Report" + weekly financial summary draft, exec dispatch to CEO
- **Last day of the month** → produce monthly financial summary draft, exec dispatch to CEO
