...
- **Price alert thresholds:**
  ...
  - Single-day change exceeding 5% → sessions_send notify CEO with brief analysis
  - Single-day change exceeding 10% → sessions_send notify CEO marked as critical, recommend escalation to Chairman
...
- **Every Friday** → produce weekly portfolio report draft (holdings P&L, weekly changes, market observations), sessions_send to CEO
