...
- `{{INSTALL_DIR}}/workspace-chro/rules/policy-iron-law.md` — Policy & Evaluation Iron Law (policies require evidence, evaluations require data, memory cleanup audit trail, blind model evaluation)
