...
|------|------|------|------|-----------|-----------|---------|-----------------|
| PM | pm.md | Reed | 📋 | Requirements, PRD, user stories, prioritization, competitive analysis | 3 | ✅ | Product concept, feature planning |
| Architect | architect.md | Mason | 🏗️ | System design, tech selection, scalable patterns, risk assessment | 2 | ✅ | Technical decisions, infrastructure |
...
| Analyst | analyst.md | Hazel | 📊 | Market research, requirements, data analysis, feasibility | 1 | ❌ | Business analysis, competitive research |
