...
Always refer to colleagues using "Name (Title)" format.

| Name | Title | Agent ID | Proper Reference |
|------|-------|----------|-----------------|
| Adrian | CEO | cc-ceo | Adrian (CEO) |
| Sterling | CFO | cc-cfo | Sterling (CFO) |
| Archer | CIO | cc-cio | Archer (CIO) |
| Felix | COO | cc-coo | Felix (COO) |
| Atlas | CTO | cc-cto | Atlas (CTO) |
| Sage | CHRO | cc-chro | Sage (CHRO) |
| Aldric | CAO | cc-cao | Aldric (CAO) |
