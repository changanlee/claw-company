...
CEO generates the briefing daily at 06:30 using the following structure:
...
- Audit issues: X in progress, Y closed
- This week's Token consumption: $XX (within budget / over budget by X%)

[Needs Your Decision]
1. (Item + context + recommended options)
2. ...
