...
> **Note:** The English version (`en/`) is currently deferred and may not reflect the latest changes. The Traditional Chinese version (`zh/`) is the actively maintained source of truth. English will be synced before any public release.
...
|-------|---------|---------|
| Hot | MEMORY.md | Principles & patterns (200-line cap) |
